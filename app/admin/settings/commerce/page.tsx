  ...
  return <div className="shell">
    ...
    <style jsx global>{`
      *{box-sizing:border-box} body{margin:0}
      .shell{min-height:100vh;display:grid;grid-template-columns:230px minmax(0,1fr);color:#172033;background:radial-gradient(circle at 15% 10%,#e7f2ff 0,transparent 32%),radial-gradient(circle at 90% 85%,#f7e5ff 0,transparent 35%),#f7f8ff;font-family:Arial,sans-serif}
      .sidebar{position:sticky;top:0;height:100vh;overflow-y:auto;padding:22px 15px 16px;display:flex;flex-direction:column;justify-content:space-between;border-right:1px solid #dce2ef;background:rgba(255,255,255,.78);backdrop-filter:blur(18px)}
      .brand{display:flex;align-items:center;gap:10px}.logo{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;color:#fff;font-weight:900;background:linear-gradient(135deg,#5268ff,#7445ee);box-shadow:0 10px 24px #6658ee35}.brand>div:last-child{display:grid}.brand strong{font-size:15px}.brand span,.role span{font-size:7px;letter-spacing:1.2px;color:#76829a;font-weight:900}
      .role{margin:20px 0;padding:10px;display:flex;gap:9px;align-items:center;border:1px solid #dce2ef;border-radius:13px;background:linear-gradient(135deg,#edf3ff,#f6efff)}.role i{width:31px;height:31px;border-radius:9px;display:grid;place-items:center;font-style:normal;background:#e3e7ff;color:#7164ef}.role>div{display:grid;gap:2px}.role strong{font-size:11px}
      .menu{display:grid;gap:4px}.menu-title{margin:9px 9px 5px;font-size:7px;letter-spacing:1.4px;font-weight:900;color:#9aa6bb}.menu-title.second{margin-top:14px}.menu-item{border:1px solid transparent;background:transparent;border-radius:10px;padding:8px 9px;display:flex;align-items:center;gap:8px;text-align:left;color:#58667d;font-size:11px;font-weight:700;cursor:pointer}.menu-item i{width:25px;height:25px;border-radius:8px;display:grid;place-items:center;background:#edf0ff;color:#6c66ef;font-style:normal}.menu-item:hover,.menu-item.active{border-color:#cfd4fa;background:linear-gradient(135deg,#edf3ff,#f7f0ff);color:#172033}
      .bottom{display:grid;gap:7px;margin-top:20px}.profile{width:100%;border:1px solid #dce2ef;border-radius:12px;padding:8px;display:flex;align-items:center;gap:8px;background:linear-gradient(135deg,#edf3ff,#f7f0ff);text-align:left;cursor:pointer}.avatar{width:34px;height:34px;border-radius:10px;overflow:hidden;display:grid;place-items:center;background:linear-gradient(135deg,#5268ff,#7445ee);color:white;font-size:11px;font-weight:900}.avatar img{width:100%;height:100%;object-fit:cover}.profile>span{display:grid;min-width:0}.profile strong{font-size:9px;max-width:135px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.profile small{font-size:7px;color:#7c879b}.logout{border:1px solid #ffd6d6;border-radius:10px;padding:8px;background:#fff1f1;color:#e54b4b;font-size:9px;font-weight:800;cursor:pointer}
      .main{min-width:0}.content{width:100%;padding:28px 22px 45px}.head{display:flex;justify-content:space-between;align-items:flex-start;gap:20px}.kicker{font-size:9px;letter-spacing:1.3px;color:#6255f5;font-weight:900}.head h1{font-size:25px;margin:7px 0 5px;letter-spacing:-.5px}.head p,.card-head p{margin:0;color:#748097;font-size:12px;line-height:1.5}.refresh{height:38px;padding:0 15px;border:1px solid #dce2ef;border-radius:11px;background:rgba(255,255,255,.75);font-size:11px;font-weight:800;cursor:pointer}
      ...
      .stats{margin-top:20px;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:11px}.stat{min-height:112px;padding:15px;border:1px solid #dde3ef;border-radius:17px;display:flex;gap:12px;align-items:flex-start;box-shadow:0 12px 30px rgba(41,48,73,.05)}.stat.blue,.blue-card{background:linear-gradient(145deg,#edf5ff,#fff)}.stat.purple,.purple-card{background:linear-gradient(145deg,#f3edff,#fff)}.stat.green,.green-card{background:linear-gradient(145deg,#e9fbf3,#fff)}.stat.pink,.pink-card{background:linear-gradient(145deg,#fff0f7,#fff)}.stat>span{width:34px;height:34px;border-radius:10px;display:grid;place-items:center;background:#ffffffaa;color:#6558f3;font-weight:900}.stat>div{display:grid;gap:4px}.stat small{font-size:8px;color:#7e89a0}.stat strong{font-size:17px}.stat p{margin:0;color:#8a95aa;font-size:9px}
      .grid{margin-top:14px;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:13px}.card{border:1px solid #dce2ef;border-radius:18px;padding:18px;box-shadow:0 14px 34px rgba(42,49,75,.045)}.card-head{margin-bottom:16px}.card-head h2{margin:5px 0 4px;font-size:17px}.toggle{display:flex;align-items:center;justify-content:space-between;gap:14px;padding:11px 12px;margin-bottom:8px;border:1px solid #dde3ef;border-radius:12px;background:rgba(255,255,255,.62)}.toggle>div{display:grid;gap:3px}.toggle strong{font-size:12px}.toggle small{font-size:9px;color:#7f8ba0}.switch{position:relative;width:42px;height:24px;border:0;border-radius:20px;background:#cfd5e1;cursor:pointer}.switch.on{background:#6c5cf3}.switch i{position:absolute;top:3px;left:3px;width:18px;height:18px;border-radius:50%;background:white;transition:.18s}.switch.on i{left:21px}
      .field{display:grid;gap:6px;margin-top:11px}.field label{font-size:10px;font-weight:800;color:#4e5a70}.field input,.field textarea{width:100%;border:1px solid #d9e0ec;border-radius:11px;padding:11px 12px;outline:none;background:rgba(255,255,255,.72);color:#1c2536;font-size:12px}.field textarea{min-height:88px;resize:vertical;line-height:1.5}.field input:focus,.field textarea:focus{border-color:#8175f5;box-shadow:0 0 0 3px #7568f314}.two{display:grid;grid-template-columns:1fr 1fr;gap:10px}
      .providers{display:grid;gap:8px}.provider{padding:10px;border:1px solid #dce2ef;border-radius:12px;background:rgba(255,255,255,.62);display:grid;grid-template-columns:36px 1fr auto;align-items:center;gap:10px}.provider-icon{width:36px;height:36px;border-radius:10px;display:grid;place-items:center;background:#edf0ff;color:#6558f3;font-size:10px;font-weight:900}.provider>div:nth-child(2){display:grid;gap:3px}.provider strong{font-size:11px}.provider small{font-size:8px;color:#7d889d;text-transform:capitalize}.provider-tags{display:flex;gap:5px;align-items:center}.provider-tags b,.provider-tags span{font-size:7px;padding:5px 7px;border-radius:20px}.provider-tags b{background:#eeeaff;color:#6658e9}.provider-tags .active{background:#e3f8ec;color:#128450}.provider-tags .inactive{background:#f3f4f7;color:#7e8797}.empty{padding:25px;text-align:center;color:#8a95a8;font-size:10px}.secure{margin:12px 0 0;font-size:9px;color:#758198;line-height:1.5}
      .savebar{position:sticky;bottom:14px;margin-top:14px;padding:12px 14px;border:1px solid #d8deea;border-radius:15px;background:rgba(255,255,255,.88);backdrop-filter:blur(18px);box-shadow:0 15px 40px rgba(42,48,73,.12);display:flex;justify-content:space-between;align-items:center;gap:15px}.savebar>div{display:grid;gap:3px}.savebar strong{font-size:12px}.savebar span{font-size:9px;color:#7d889d}.savebar button{border:0;border-radius:11px;padding:11px 18px;background:linear-gradient(135deg,#5268ff,#7445ee);color:white;font-size:11px;font-weight:900;cursor:pointer}.savebar button:disabled,.refresh:disabled{opacity:.55;cursor:not-allowed}
