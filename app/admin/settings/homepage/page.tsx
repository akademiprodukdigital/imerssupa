...
function Styles() {
  return <style jsx global>{`
    *{box-sizing:border-box}html,body{margin:0}button,input,textarea,select{font:inherit}
    ...
    .top>div:first-child span{font-size:11px;font-weight:900;letter-spacing:1px;color:var(--text-muted)}
    ...
    .hero>div:first-child>span,.status small{font-size:11px;font-weight:950;letter-spacing:1.3px;color:var(--accent)}
    ...
    .status{min-width:230px;padding:19px;border:1px solid var(--border);border-radius:18px;background:var(--surface-gradient);display:grid;gap:7px}.status strong{font-size:18px}.status span{font-size:12px;color:#22c55e}
    ...
    .designLayout{display:grid;grid-template-columns:1fr 390px;gap:14px}.preview{min-height:480px;padding:21px;overflow:hidden;border:1px solid var(--border);border-radius:22px;color:#fff;background:linear-gradient(145deg,var(--b1),var(--b2));box-shadow:var(--shadow)}.preview>small{font-size:10px;font-weight:900;letter-spacing:1px;color:#94a3b8}.miniNav{margin-top:16px;padding:12px;display:flex;justify-content:space-between;border:1px solid rgba(255,255,255,.1);border-radius:var(--r);background:rgba(255,255,255,.05)}.miniNav b{font-size:13px}.miniNav span{font-size:11px;color:#cbd5e1}.miniHero{padding:45px 8px}.miniHero label{font-size:10px;font-weight:900;color:var(--a)}.miniHero h3{margin:10px 0;font-family:var(--heading);font-size:31px;line-height:1.05}.miniHero h3 em{display:block;font-style:normal;color:var(--a)}.miniHero p{font-size:12px;line-height:1.55;color:#cbd5e1}.miniHero button{margin-top:10px;padding:11px 14px;border:0;border-radius:11px;color:#fff;background:linear-gradient(135deg,var(--p),var(--s));font-size:12px;font-weight:900}
    .htmlNotice{margin-bottom:13px;padding:12px;border:1px solid rgba(99,102,241,.15);border-radius:12px;color:var(--text-secondary);background:rgba(99,102,241,.06);font-size:12px;line-height:1.5}.code{width:100%;min-height:470px;padding:17px;border:1px solid var(--border);border-radius:14px;outline:none;resize:vertical;color:#dbeafe;background:#020617;font:13px/1.65 Consolas,Monaco,monospace}.htmlBottom{margin-top:11px;display:flex;align-items:center;justify-content:space-between}.htmlBottom span{font-size:12px;color:var(--text-muted)}.htmlBottom button{padding:10px 13px;border:1px solid var(--border);border-radius:10px;color:var(--text-primary);background:var(--surface-gradient);font-size:12px;font-weight:800;cursor:pointer}
