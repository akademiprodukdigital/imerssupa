...
function Styles() {
  return <style jsx global>{`
    *{box-sizing:border-box}html,body{margin:0}button,input,textarea,select{font:inherit}button{cursor:pointer}
    ...
    .crumb button,.outline{padding:10px 14px;border:1px solid var(--border);border-radius:12px;color:var(--text-secondary);background:var(--surface-gradient);font-size:13px;font-weight:800}.crumb span{font-size:11px;font-weight:900;letter-spacing:1px;color:var(--text-muted)}
    ...
    .eyebrow,.adminCard small{font-size:11px;font-weight:950;letter-spacing:1.3px;color:var(--accent)}.hero h1{margin:7px 0 10px;font-size:44px;line-height:1;letter-spacing:-1.8px}.hero h1 em{font-style:normal;color:transparent;background:linear-gradient(90deg,#38bdf8,#6366f1,#a855f7);background-clip:text}.hero p{max-width:720px;margin:0;color:var(--text-muted);font-size:14px;line-height:1.65}
    .adminCard{min-width:230px;padding:19px;border:1px solid var(--border);border-radius:18px;background:var(--surface-gradient);display:grid;gap:7px}.adminCard strong{font-size:17px}.adminCard span{font-size:12px;color:#22c55e}
    ...
    .grid2{display:grid;grid-template-columns:repeat(2,1fr);gap:16px}.field{display:grid;gap:7px}.field.wide{grid-column:1/-1}.field>span{font-size:12px;font-weight:850;color:var(--text-secondary)}.field input,.field textarea,.field select{width:100%;padding:12px 13px;border:1px solid var(--border);border-radius:12px;outline:none;color:var(--text-primary);background:var(--surface-soft);font-size:14px}.field textarea{resize:vertical;line-height:1.55}.field input:focus,.field textarea:focus,.field select:focus{border-color:rgba(99,102,241,.5);box-shadow:0 0 0 3px rgba(99,102,241,.08)}
    ...
    .previewLogo{margin-bottom:10px;display:flex;align-items:center;gap:7px}.previewLogo img{width:27px;height:27px;object-fit:contain}.previewLogo i{width:27px;height:27px;display:flex;align-items:center;justify-content:center;border-radius:8px;background:rgba(255,255,255,.15);font-size:9px;font-style:normal}.previewLogo b{font-size:10px;overflow:hidden;text-overflow:ellipsis}.previewSide small{padding:7px;border-radius:7px;font-size:9px}.previewSide small:first-of-type{background:rgba(255,255,255,.12)}
    .previewMain{padding:28px 17px}.previewMain label{font-size:9px;font-weight:900;color:var(--preview-accent)}.previewMain h3{margin:6px 0;font-size:22px}.previewMain p{margin:0;color:var(--text-muted);font-size:10px;line-height:1.5}.previewCards{margin:20px 0 15px;display:grid;grid-template-columns:1fr 1fr;gap:8px}.previewCards div{padding:13px;border:1px solid var(--border);border-radius:14px;background:var(--card-gradient);display:grid;gap:3px}.previewCards b{font-size:18px}.previewCards span{font-size:9px;color:var(--text-muted)}.previewMain button,.loginPreview button{padding:10px 13px;border:0;border-radius:10px;color:white;background:linear-gradient(135deg,var(--preview-primary,#4f46e5),var(--preview-secondary,#7c3aed));font-size:10px;font-weight:900}
    .deploymentBox{display:grid;grid-template-columns:1fr 1fr;gap:15px}.tip{padding:13px 14px;display:grid;gap:4px;border:1px solid rgba(56,189,248,.18);border-radius:13px;background:rgba(56,189,248,.06)}.tip b{font-size:12.5px;color:var(--accent)}.tip span{font-size:11.5px;line-height:1.5;color:var(--text-muted)}
    .routeList{margin-top:20px;border:1px solid var(--border);border-radius:16px;overflow:hidden}.routeHead{padding:14px 15px;display:flex;align-items:center;justify-content:space-between;background:var(--surface-soft)}.routeHead b{font-size:13px}.routeHead span{font-size:11px;color:var(--text-muted)}.route{padding:12px 15px;display:grid;grid-template-columns:170px 1fr;align-items:center;border-top:1px solid var(--border)}.route span{font-size:12px;font-weight:750;color:var(--text-secondary)}.route code{overflow:auto;font-size:12px;color:var(--accent)}
    .providerNote{margin-top:17px;padding:16px;border:1px solid rgba(34,197,94,.18);border-radius:15px;background:rgba(34,197,94,.06)}.providerNote strong{font-size:13px;color:#22c55e}.providerNote p{margin:5px 0 0;font-size:12px;line-height:1.55;color:var(--text-muted)}
    .formStack{display:grid;gap:16px}.loginPreview{min-height:500px;background:linear-gradient(145deg,rgba(59,130,246,.08),rgba(124,58,237,.08)),var(--card-gradient)}.loginBrand{margin:25px 0 35px;display:flex;align-items:center;gap:10px}.loginBrand img{width:42px;height:42px;object-fit:contain}.logoFallback{width:42px;height:42px;display:flex;align-items:center;justify-content:center;border-radius:12px;color:#fff;background:var(--primary-gradient);font-size:11px;font-weight:900}.loginBrand b{font-size:16px}.loginPreview>label{font-size:10px;font-weight:900;letter-spacing:1px;color:var(--accent)}.loginPreview h3{margin:8px 0;font-size:27px;line-height:1.08}.loginPreview p{margin:0 0 24px;font-size:12.5px;line-height:1.6;color:var(--text-muted)}.fakeInput{margin-bottom:9px;padding:12px;border:1px solid var(--border);border-radius:11px;color:var(--text-muted);background:var(--surface-soft);font-size:11px}.loginPreview button{width:100%;margin-top:5px;padding:12px;background:var(--primary-gradient);font-size:12px}
    .bottomSave{margin-top:18px;padding:17px 19px;display:flex;align-items:center;justify-content:space-between;gap:15px;border:1px solid var(--border);border-radius:18px;background:var(--surface-gradient);box-shadow:var(--shadow)}.bottomSave>div{display:grid;gap:3px}.bottomSave strong{font-size:14px}.bottomSave span{font-size:12px;color:var(--text-muted)}
