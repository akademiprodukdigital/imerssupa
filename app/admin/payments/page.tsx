...
@media(max-width:900px){.sidebar{width:230px}.content{margin-left:230px;padding:24px 20px}.stats{grid-template-columns:1fr}}@media(max-width:760px){.sidebar{display:none}.content{margin-left:0;padding:28px 14px}.filters{flex-wrap:wrap}.search{flex-basis:100%}.filters select{height:36px;flex:1}.pagination>span{display:none}header{display:block}.refresh{margin-top:12px}}`}</style>
 </div>
}
