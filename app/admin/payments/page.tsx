...
export default function AdminPaymentsPage(){
 ...
 return <div className="admin-shell">
  ...
  <section className="stats"><div className="stat statBlue"><span>◉</span><div><small>DATA DITEMUKAN</small><strong>{total.toLocaleString('id-ID')}</strong><p>Sesuai filter aktif</p></div></div><div className="stat statPurple"><span>⌛</span><div><small>WAITING DI HALAMAN INI</small><strong>{waiting}</strong><p>Perlu verifikasi admin</p></div></div><div className="stat statMint"><span>Rp</span><div><small>NOMINAL HALAMAN INI</small><strong>{money(amount)}</strong><p>{start}–{end} dari {total}</p></div></div></section>
